// ==========================================
// 🎮 BỘ ĐIỀU KHIỂN KÉP (PC & MOBILE) - VÁ LỖI CẢM ỨNG
// ==========================================
...
(function () {
    ...
    let joyActiveId = null; let joyCenter = { x: 0, y: 0 }; let joyRadius = 50;

    if (mZoneLeft && mJoyBase && mJoyStick) {
        mZoneLeft.addEventListener('touchstart', (e) => {
            ...
            mJoyBase.style.opacity = '1'; // Sáng lên khi chạm
        ...
        function resetJoyStick(e) {
            ...
            if (lifted || e.type === 'touchcancel') {
                joyActiveId = null;
                // Trả joyStick về góc trái mờ mờ mặc định
                mJoyBase.style.left = '80px'; mJoyBase.style.top = 'calc(100vh - 100px)';
    ...
    window.addEventListener('pointerdown', (e) => {
        ...
        raycaster.setFromCamera(mouse, window.camera); const hits = raycaster.intersectObjects(window.scene.children, true);
