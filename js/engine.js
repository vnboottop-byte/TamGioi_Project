...
if (isAdmin) {
    ...
    controls.maxDistance = 150; // Cho phép lăn chuột ra xa tít mù tắp để nhìn cả bản đồ
    controls.minDistance = 4;    // Không cho zoom quá gần để tránh chui vào trong bụng Titan
} else {
    // 👤 NGƯỜI THƯỜNG: Giữ nguyên như cũ
    controls.maxDistance = 150;   // Chỉ cho phép nhìn quanh quẩn nhân vật
    controls.minDistance = 4;     // Có thể nhìn sát mặt nhân vật
}
