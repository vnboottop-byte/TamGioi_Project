...
if (isAdmin) {
    ...
    controls.maxDistance = 10; // Cho phép lăn chuột ra xa tít mù tắp để nhìn cả bản đồ
    controls.minDistance = 3;    // Không cho zoom quá gần để tránh chui vào trong bụng Titan
} else {
    // 👤 NGƯỜI THƯỜNG: Giữ nguyên như cũ
    controls.maxDistance = 10;   // Chỉ cho phép nhìn quanh quẩn nhân vật
...
window.xuLyXoaBossOxa = function () {
    ...
    let maxDistToKeep = window.isMobile ? 2500 : 4500;
